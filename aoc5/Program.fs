...
let instructionUnaryOp = function
    | 5 -> ((<>) 0)
    | 6 -> ((=) 0)
    | _ -> failwith "Invalid opcode"

let getValueByMode instructionPtr (state: int array) mode =
    match mode with
